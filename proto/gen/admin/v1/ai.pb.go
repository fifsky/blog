...
// RemindSpeechTranscribeRequest 提醒语音识别请求
type RemindSpeechTranscribeRequest struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AudioBase64 string                 `protobuf:"bytes,1,opt,name=audio_base64,json=audioBase64,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}

func (x *RemindSpeechTranscribeRequest) Reset() {
	*x = RemindSpeechTranscribeRequest{}
	mi := &file_admin_v1_ai_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemindSpeechTranscribeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemindSpeechTranscribeRequest) ProtoMessage() {}

func (x *RemindSpeechTranscribeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_admin_v1_ai_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *RemindSpeechTranscribeRequest) GetAudioBase64() string {
	if x != nil {
		return x.xxx_hidden_AudioBase64
	}
	return ""
}

func (x *RemindSpeechTranscribeRequest) SetAudioBase64(v string) {
	x.xxx_hidden_AudioBase64 = v
}

type RemindSpeechTranscribeRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	AudioBase64 string
}

func (b0 RemindSpeechTranscribeRequest_builder) Build() *RemindSpeechTranscribeRequest {
	m0 := &RemindSpeechTranscribeRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_AudioBase64 = b.AudioBase64
	return m0
}

// RemindSpeechTranscribeResponse 提醒语音识别响应
type RemindSpeechTranscribeResponse struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
...
func (x *RemindSpeechTranscribeResponse) Reset() {
	*x = RemindSpeechTranscribeResponse{}
	mi := &file_admin_v1_ai_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemindSpeechTranscribeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemindSpeechTranscribeResponse) ProtoMessage() {}

func (x *RemindSpeechTranscribeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_admin_v1_ai_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *RemindSpeechTranscribeResponse) GetText() string {
	if x != nil {
...
func (x *RemindSpeechTranscribeResponse) SetText(v string) {
	x.xxx_hidden_Text = v
}

type RemindSpeechTranscribeResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	Text string
}

func (b0 RemindSpeechTranscribeResponse_builder) Build() *RemindSpeechTranscribeResponse {
	m0 := &RemindSpeechTranscribeResponse{}
	b, x := &b0, m0
	_, _ = b, x
...
const file_admin_v1_ai_proto_rawDesc = "" +
	...
	"\acontent\x18\x01 \x01(\tB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\acontent\"M\n" +
	"\x1dRemindSpeechTranscribeRequest\x12,\n" +
	"\faudio_base64\x18\x01 \x01(\tB\t\xe0A\x02\xbaH\x03\xc8\x01\x01R\vaudioBase64\"4\n" +
	"\x1eRemindSpeechTranscribeResponse\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\"0\n" +
	"\x14GenerateMoodResponse\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent2\xc8\x04\n" +
	...
	"\x11RemindSmartCreate\x12..fifsky.blog.admin.v1.RemindSmartCreateRequest\x1a\x1d.fifsky.blog.types.IDResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/blog/admin/ai/remind/create\x12\xb0\x01\n" +
	"\x16RemindSpeechTranscribe\x123.fifsky.blog.admin.v1.RemindSpeechTranscribeRequest\x1a4.fifsky.blog.admin.v1.RemindSpeechTranscribeResponse\"+\x82\xd3\xe4\x93\x02%:\x01*\" /blog/admin/ai/remind/transcribe\x12r\n" +
...
var file_admin_v1_ai_proto_goTypes = []any{
	...
	(*RemindSpeechTranscribeRequest)(nil),  // 3: fifsky.blog.admin.v1.RemindSpeechTranscribeRequest
	(*RemindSpeechTranscribeResponse)(nil), // 4: fifsky.blog.admin.v1.RemindSpeechTranscribeResponse
	(*GenerateMoodResponse)(nil),           // 5: fifsky.blog.admin.v1.GenerateMoodResponse
...
var file_admin_v1_ai_proto_depIdxs = []int32{
	...
	3, // 2: fifsky.blog.admin.v1.AIService.RemindSpeechTranscribe:input_type -> fifsky.blog.admin.v1.RemindSpeechTranscribeRequest
	6, // 3: fifsky.blog.admin.v1.AIService.GenerateMood:input_type -> google.protobuf.Empty
	1, // 4: fifsky.blog.admin.v1.AIService.GenerateTags:output_type -> fifsky.blog.admin.v1.GenerateTagsResponse
	7, // 5: fifsky.blog.admin.v1.AIService.RemindSmartCreate:output_type -> fifsky.blog.types.IDResponse
	4, // 6: fifsky.blog.admin.v1.AIService.RemindSpeechTranscribe:output_type -> fifsky.blog.admin.v1.RemindSpeechTranscribeResponse
	5, // 7: fifsky.blog.admin.v1.AIService.GenerateMood:output_type -> fifsky.blog.admin.v1.GenerateMoodResponse
