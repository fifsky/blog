...
const (
	SettingService_Get_FullMethodName    = "/fifsky.blog.admin.v1.SettingService/Get"
	SettingService_Update_FullMethodName = "/fifsky.blog.admin.v1.SettingService/Update"
)
...
type SettingServiceClient interface {
	// Get 获取后台设置
	Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AdminSetting, error)
	// Update 更新设置
	Update(ctx context.Context, in *AdminSetting, opts ...grpc.CallOption) (*AdminSetting, error)
}
...
func (c *settingServiceClient) Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AdminSetting, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminSetting)
...
func (c *settingServiceClient) Update(ctx context.Context, in *AdminSetting, opts ...grpc.CallOption) (*AdminSetting, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminSetting)
...
func (UnimplementedSettingServiceServer) Get(context.Context, *emptypb.Empty) (*AdminSetting, error) {
	return nil, status.Error(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedSettingServiceServer) Update(context.Context, *AdminSetting) (*AdminSetting, error) {
...
func _SettingService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingServiceServer).Update(ctx, req.(*AdminSetting))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SettingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fifsky.blog.admin.v1.SettingService",
	...
	Metadata: "admin/v1/setting.proto",
}
