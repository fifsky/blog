...
type SettingServiceClient interface {
	// Get 获取设置
	Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Setting, error)
...
func (c *settingServiceClient) Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Setting, error) {
...
func (UnimplementedSettingServiceServer) Get(context.Context, *emptypb.Empty) (*Setting, error) {
