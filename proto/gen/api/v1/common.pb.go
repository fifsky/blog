...
func (x *ErorResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ErorResponse) ProtoMessage() {}

func (x *ErorResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_common_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ErorResponse.ProtoReflect.Descriptor instead.
func (*ErorResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_common_proto_rawDescGZIP(), []int{6}
}

func (x *ErorResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ErorResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
const file_api_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x13api/v1/common.proto\x12\x12fifsky.blog.api.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bbuf/validate/validate.proto\"'\n" +
	"\tIDRequest\x12\x1a\n" +
	...
	"\x04page\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x04page\"\x7f\n" +
	"\aOptions\x12=\n" +
	"\x02kv\x18\x01 \x03(\v2#.fifsky.blog.api.v1.Options.KvEntryB\b\xbaH\x05\x9a\x01\x02\b\x01R\x02kv\x1a5\n" +
	"\aKvEntry\x12\x10\n" +
	...
	"\x06domain\x18\x03 \x01(\tR\x06domain\"4\n" +
	"\fErorResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msgB\xac\x01\n" +
	"\x16com.fifsky.blog.api.v1B\vCommonProtoP\x01Z\x1aapp/proto/gen/api/v1;apiv1\xa2\x02\x03FBA\xaa\x02\x12Fifsky.Blog.Api.V1\xca\x02\x12Fifsky\\Blog\\Api\\V1\xe2\x02\x1eFifsky\\Blog\\Api\\V1\\GPBMetadata\xea\x02\x15Fifsky::Blog::Api::V1b\x06proto3"
...
var file_api_v1_common_proto_goTypes = []any{
	(*IDRequest)(nil),    // 0: fifsky.blog.api.v1.IDRequest
	(*IDResponse)(nil),   // 1: fifsky.blog.api.v1.IDResponse
	(*PageRequest)(nil),  // 2: fifsky.blog.api.v1.PageRequest
	(*Options)(nil),      // 3: fifsky.blog.api.v1.Options
	(*UserSummary)(nil),  // 4: fifsky.blog.api.v1.UserSummary
	(*CateSummary)(nil),  // 5: fifsky.blog.api.v1.CateSummary
	(*ErorResponse)(nil), // 6: fifsky.blog.api.v1.ErorResponse
	nil,                  // 7: fifsky.blog.api.v1.Options.KvEntry
}
var file_api_v1_common_proto_depIdxs = []int32{
	7, // 0: fifsky.blog.api.v1.Options.kv:type_name -> fifsky.blog.api.v1.Options.KvEntry
