...
func TestComment_List(t *testing.T) {
	dbunit.New(t, func(d *dbunit.DBUnit) {
		...
		svc := NewComment(store.New(db), feishu.Config{}, WithCommentModerator(&MockModerator{ShouldPass: true}))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			dbunit.New(t, func(d *dbunit.DBUnit) {
				...
				svc := NewComment(store.New(db), feishu.Config{}, WithCommentModerator(tt.moderator))
...
func TestComment_Create_WebsiteNotIncludedInModeration(t *testing.T) {
	...
	dbunit.New(t, func(d *dbunit.DBUnit) {
		...
		svc := NewComment(store.New(db), feishu.Config{}, WithCommentModerator(mock))
