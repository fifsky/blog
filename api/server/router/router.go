...
func (r *Router) Handler() http.Handler {
	...
	mux.Handle("POST /api/admin/article/post", adminAuth.HandlerFunc(r.handler.Article.Post))
	...
	mux.Handle("POST /api/admin/setting/post", adminAuth.HandlerFunc(r.handler.Setting.Post))
	...
	mux.Handle("POST /api/admin/mood/post", adminAuth.HandlerFunc(r.handler.Mood.Post))
	mux.Handle("POST /api/admin/mood/delete", adminAuth.HandlerFunc(r.handler.Mood.Delete))
	mux.Handle("POST /api/admin/cate/post", adminAuth.HandlerFunc(r.handler.Cate.Post))
	...
	mux.Handle("POST /api/admin/link/post", adminAuth.HandlerFunc(r.handler.Link.Post))
	...
	mux.Handle("POST /api/admin/remind/post", adminAuth.HandlerFunc(r.handler.Remind.Post))
	...
	mux.Handle("POST /api/admin/user/post", adminAuth.HandlerFunc(r.handler.User.Post))
